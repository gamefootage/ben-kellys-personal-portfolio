...
* On IE 10+ the Gaelic Football stock image fails to load and browser doesn't support 'object-fit: cover' so timeline images are at different widths to avoid stretching.
